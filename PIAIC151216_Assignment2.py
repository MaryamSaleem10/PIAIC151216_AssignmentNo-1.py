...
def function1():
    ...
    x =  np.arange(1,12).reshape(6,2)# Write your code here 
...
def function2():
    ...
    x =     np.arange(10,37).astype('float64').reshape(3,3,3)#wrtie your code here
...
def function7():
    ...
    return np.zeros(np.shape(x))#write your code here
...
def function8():
    ...
    x = np.ones((2,5))*6#write your code here
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt = ((arr[0]-brr[0]),(arr[1]-brr[1]),(arr[1]-brr[1]))# write your code here 
...
def function18():
    ...
    x = piaic[(students==piaic)].sum()# Write you code Here
    return x
